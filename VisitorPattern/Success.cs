...
namespace VisitorPattern
{
    ...
    public class Success : Action
    {
        ...
        {
            Console.WriteLine($"{nameof(concreElementA)}{this.GetType().Name}时，背后多半有一个伟大的女人");
        }

        public override void GetWomanConclusion(Woman concreElementB)
        {
            Console.WriteLine($"{nameof(concreElementB)}{this.GetType().Name}时，背后多半有一个不成功的男人");
        }
    }
    ...
    public class Failing : Action
    {
        public override void GetManConclusion(Man concreElementA)
        {
            Console.WriteLine($"{nameof(concreElementA)}{this.GetType().Name}时，蒙头喝酒");
        }
    ...
    public class Amativeness : Action
    {
        ...
        public override void GetWomanConclusion(Woman concreElementB)
        {
            Console.WriteLine($"{nameof(concreElementB)}{this.GetType().Name}时，懂也装作不懂");
        }
    }
}
